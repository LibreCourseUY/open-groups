# Contributing to OpenGroups

Thank you for your interest in contributing to OpenGroups! This guide will walk you through how to contribute, step by step.
...
1. Go to: https://github.com/LibreCourseUY/open-groups
...
```bash
git clone https://github.com/YOUR_USERNAME/open-groups.git
cd open-groups
```
